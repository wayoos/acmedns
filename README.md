# acmedns [![Build Status](https://travis-ci.org/wayoos/acmedns.svg?branch=master)](https://travis-ci.org/wayoos/acmedns)

Acmedns is a script to issue and renew TLS certs from [Let's Encrypt](https://letsencrypt.org/) with DNS challenge.
...
* use acmedns.py with acmedns.conf file.
* use [acmedns](https://hub.docker.com/r/wayoos/acmedns/) docker image from docker hub.
...
I bootstrap this program with the [acme-tiny](https://github.com/diafygi/acme-tiny) script.